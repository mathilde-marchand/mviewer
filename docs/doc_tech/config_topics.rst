...
* ``layersvisibility`` :guilabel:`studio` : paramètre optionnel (all/none/default) qui précise la visibilité des couches dans la thématique externe. Valeur par défaut **default**.
